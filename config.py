...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "6779472292:AAGl49ROv3n1I8NcRsNjJ9h2FFlgfICFrz0")
...
DB_NAME = os.environ.get("DATABASE_NAME", "KannadaMovieofficial")
